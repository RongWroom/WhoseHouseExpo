...
import { View, Pressable, TouchableOpacity, Image, ScrollView } from 'react-native';
import { useRouter } from 'expo-router';
import { LogOut, User, ChevronRight, HelpCircle } from 'lucide-react-native';
import { useAuth } from '../../../src/contexts/AuthContext';
import { Screen, Container, Card, CardContent, Text, TitleBar } from '../../../src/components/ui';
import { THEME } from '../../../src/lib/theme';
import { NotificationSettings } from '../../../src/components/settings/NotificationSettings';
import { HouseholdSettings } from '../../../src/components/settings/HouseholdSettings';
import { AvailabilitySettings } from '../../../src/components/settings/AvailabilitySettings';
import { PlacementRequests } from '../../../src/components/settings/PlacementRequests';
...
export default function FosterCarerSettingsScreen() {
  ...
  const navigateToProfile = () => {
    router.push('/(foster_carer)/profile');
  };
    ...
    <Screen backgroundColor="bg-gray-50">
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <Container className="py-6">
            ...
            <Card variant="elevated" className="mb-6">
              <CardContent className="flex-row items-center">
                {avatarUrl ? (
                  ...
                  <View className="w-16 h-16 rounded-full bg-foster-carer-500 items-center justify-center mr-4">
                ...
                <View className="flex-1">
                  ...
                  <Text className="text-sm text-foster-carer-600 font-medium mt-1">
                    View & Edit Profile
                  </Text>
                </View>
          ...
          <View className="mb-6">
            <AvailabilitySettings isPrimaryCarer={profile?.is_primary_carer ?? false} />
          </View>
          ...
          <View className="mb-6">
            <HouseholdSettings onHouseholdChange={refreshProfile} />
          </View>
          ...
          <View className="mb-6">
            <NotificationSettings accentColor={THEME.roles.fosterCarer.primary} />
          </View>
